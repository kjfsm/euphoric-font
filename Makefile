...
SHEETS=$(wildcard sources/*.png sources/*.txt)
...
$(SOURCES): venv scripts/png2ufo.py sources/config.yaml $(SHEETS)
	. venv/bin/activate; python3 scripts/png2ufo.py
