...
FONT_PATH = "fonts/ttf/EuphoricPixel-Regular.ttf"
FONT_LICENSE = "OFL v1.1"
# CI の Linux には Helvetica が無いので、このフォント自身で書く。
AUXILIARY_FONT = FONT_PATH
AUXILIARY_FONT_SIZE = 48

BIG_TEXT = "AaBb"
# 1em が 8 ドットなので、8 の倍数にするとドットの縁がピクセルに揃う。
...
def git(command):
    # scripts/docker-make の中からは git のリポジトリが見えないことがある。
    try:
...
MY_URL = git("git remote get-url origin")
MY_HASH = git("git rev-parse --short HEAD")
